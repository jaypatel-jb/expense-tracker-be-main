...
// @access  Private/Admin
export const getVersionById = async (req: Request, res: Response): Promise<any> => {
  try {
...
// @access  Private/Admin
export const updateVersion = async (req: Request, res: Response): Promise<any> => {
  try {
    const { name, version } = req.body
    ...
    // Update version
    versionDoc = await Version.findByIdAndUpdate(req.params.id, { name, version }, { new: true, runValidators: true })
...
// @access  Private/Admin
export const deleteVersion = async (req: Request, res: Response): Promise<any> => {
  try {
    // Check if version exists
    const version = await Version.findById(req.params.id)
